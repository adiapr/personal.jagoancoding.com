        ...
        <div class="about">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <img src="https://tes.anthonykusuma.com/assets/img/personalization.svg" style="width:100%">
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" required class="form-control form-control-sm" placeholder="Masukkan nama anak">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for=""><b>Umur :</b></label>
                            <input type="number" name="umur" required max="30" class="form-control form-control-sm" placeholder="Dalam tahun">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for=""><b>No Whatsapp :</b></label>
                            <input type="number" name="nama" required class="form-control form-control-sm" placeholder="Masukkan No whatsapp anda">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">1.&nbsp; </td>
                                    <td valign="top"><input type="number" name="1A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                ...
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="1B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak tidak pernah santai, ia selalu ingin bermain  </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="1C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak lebih berperilaku menyenangkan, ia lebih banyak tersenyum dan tertawa daripada menangis </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="1D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">2.&nbsp; </td>
                                    <td valign="top"><input type="number" name="2A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak bertindak dengan cepat dan mandiri serta suka mengerjakan sesuatunya sendiri </td>
                                </tr>
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="2B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                ...
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="2C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                ...
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="2D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">3.&nbsp; </td>
                                    <td valign="top"><input type="number" name="3A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini tidak memberikan tanggapan  berlebihan atas kasih sayang yang diberikan </td>
                                </tr>
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="3B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini terlihat optimis dan antusias dalam hampir semua situasi </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="3C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                ...
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="3D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">4.&nbsp; </td>
                                    <td valign="top"><input type="number" name="4A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini umumnya sangat aktif, ia suka menjelajah dan mencoba hal baru serta suka mengambil resiko </td>
                                </tr>
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="4B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini mudah bergaul dengan orang dan suka keramaian </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="4C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini mudah bekerjja sama dengan orang lain dan cocok dengan orang lain </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="4D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">5.&nbsp; </td>
                                    <td valign="top"><input type="number" name="5A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini sulit dipimpin dan akn memilih siapa yang ia ikuti </td>
                                </tr>
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="5B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini berpinda-pindah kegiatan tanpa menyelesaikan kegiatan awalnya </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="5C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini mudah menyerah jika mendapat tekanan </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="5D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">6.&nbsp; </td>
                                    <td valign="top"><input type="number" name="6A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak gampang marah dan memaksa mendapat apa yang ia inginkan </td>
                                </tr>
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="6B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak berantakan dan pelupa </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="6C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini sulit menerima perubahan yang mendadak </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="6D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">7.&nbsp; </td>
                                    <td valign="top"><input type="number" name="7A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak menyukai persaingan  </td>
                                </tr>
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="7B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak terlalu peduli dengan apa yang dikerjakan orang lain  </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="7C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini tidak suka berkelahi dan menghindari pertentangan </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="7D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="card shadow-sm p-3">
                            <table>
                                <tr>
                                    <td valign="top">8.&nbsp; </td>
                                    <td valign="top"><input type="number" name="8A" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak ini mengatakan apa yang dipikirkan dan memberi tau apa yang diinginkan </td>
                                </tr>
                                <tr>
                                    <td valign="top">&nbsp; </td>
                                    <td valign="top"><input type="number" name="8B" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak gemar Bercerita </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="8C" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
                                    <td valign="top">Anak lebih mendegarkan </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    <td valign="top"><input type="number" name="8D" style="width: 50px" max="4" required>&nbsp;&nbsp;&nbsp;</td>
